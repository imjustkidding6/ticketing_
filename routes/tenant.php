...
Route::middleware(['auth', 'verified', 'tenant'])->group(function () {
    ...
    Route::get('reports/export/volume', [ReportController::class, 'exportVolume'])->name('reports.export.volume');
    Route::get('reports/export/tickets', [ReportController::class, 'exportTickets'])->name('reports.export.tickets');
    Route::get('reports/export/departments', [ReportController::class, 'exportDepartmentReport'])->name('reports.export.departments');
    Route::get('reports/export/categories', [ReportController::class, 'exportCategoryReport'])->name('reports.export.categories');
