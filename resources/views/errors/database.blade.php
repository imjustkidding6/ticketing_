    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-lg w-full text-center">
            ...
            <div class="relative mx-auto mb-8">
                <div class="text-[10rem] font-bold leading-none text-gray-200 select-none">DB</div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 mb-3">{{ __('Database Error') }}</h1>
            <p class="text-gray-500 mb-2 max-w-sm mx-auto">
                {{ __('Something went wrong while saving or reading data.') }}
            </p>
            <p class="text-gray-400 text-sm mb-8 max-w-sm mx-auto">
                {{ __('This is usually a temporary issue. Try going back and submitting again. If it keeps happening, please contact support.') }}
            </p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <button onclick="location.reload()" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors">
                    <svg class="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="mt-12 flex items-center justify-center gap-1.5 text-xs text-gray-400">
                <div class="h-1.5 w-1.5 rounded-full bg-red-400 animate-pulse"></div>
                {{ __('Error code: DB_500') }}
            </div>
