                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="tier" id="tier" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    <option value="basic" {{ old('tier', 'basic') === 'basic' ? 'selected' : '' }}>{{ __('Basic') }}</option>
                                    <option value="premium" {{ old('tier') === 'premium' ? 'selected' : '' }}>{{ __('Premium') }}</option>
                                    <option value="enterprise" {{ old('tier') === 'enterprise' ? 'selected' : '' }}>{{ __('Enterprise') }}</option>
                                </select>
