<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-full px-4 sm:px-4 lg:px-6">
                            ...
                            @foreach($onboarding['steps'] as $step)
                                <button
                                    ...
                                    @if(!$step['completed'])
                                        ...
                                        class="flex items-center gap-3 rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800 px-4 py-3 text-left transition hover:border-indigo-300 hover:shadow-sm"
                                    @else
                                        disabled
            ...
            {{-- ── Activity Feed + Quick Actions + Profile ── --}}
            <div class="mt-6 grid gap-6 lg:grid-cols-2">
                {{-- My Activity Feed --}}
                <div class="rounded-xl bg-white p-6 shadow-sm">
                    <div class="flex items-center justify-between">
                        ...
                        @if($myActivity->count() > 0)
                            <a href="{{ route('dashboard.my-activity') }}" class="text-xs font-medium text-indigo-600 hover:text-indigo-800">
                                {{ __('View All') }}
                            </a>
                        @endif
                    </div>
                ...
                {{-- Quick Actions + Profile Summary (stacked to fill the right column) --}}
                <div class="space-y-6">
                    {{-- Quick Actions --}}
                    <div class="rounded-xl bg-white p-6 shadow-sm">
                        <h3 class="text-lg font-semibold text-gray-900">{{ __('Quick Actions') }}</h3>
                        <div class="mt-4 grid grid-cols-2 gap-3">
                            <a href="{{ route('tickets.create') }}" class="flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-indigo-300 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
                            ...
                            <a href="{{ route('tickets.index', ['assigned_to' => Auth::id()]) }}" class="flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-indigo-300 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
                            ...
                            <a href="{{ route('clients.index') }}" class="flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-indigo-300 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
                            ...
                            <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-indigo-300 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
