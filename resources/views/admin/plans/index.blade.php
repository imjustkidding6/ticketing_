                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <div class="relative w-full md:w-72">
                        ...
                        <input type="text" 
                               ...
                               class="w-full pl-10 pr-4 py-2 bg-white dark:bg-[var(--bg-app)] border border-slate-200 dark:border-[var(--border-soft)] rounded-xl text-sm text-slate-900 dark:text-[var(--text-primary)] placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition duration-150">
                    </div>
