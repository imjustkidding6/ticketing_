    ...
    <div class="bg-white shadow overflow-hidden rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                <form action="{{ route('admin.tenants.impersonate', $tenant) }}" method="POST" class="inline" onsubmit="return confirm('Switch into this tenant\'s view?')">
                    @csrf
                    <button type="submit" class="inline-flex items-center px-3 py-1 border border-indigo-300 rounded-md text-sm text-indigo-700 hover:bg-indigo-50">
