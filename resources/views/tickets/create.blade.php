            ...
            <div class="overflow-hidden rounded-xl bg-white p-6 shadow-sm">
                <form method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        @if($aiAssist)
                        <div x-data="ticketAiAssist()" class="rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-violet-50 p-4">
                            <div class="flex items-start gap-2.5">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p class="mt-0.5 text-xs text-indigo-700">{{ __('Jot rough notes in the Subject and Description below, then let AI rewrite them clearly and suggest resolution tasks. Clean, consistent tickets help the assistant learn from how your team resolves them.') }}</p>
